...
aliases:
  - /2010/01/07/largest-square-array-of-same-integers
  - /2010/01/largest-square-array-of-same-integers
---

Tonight it's a challenging one. Or, better, a problem of which is really difficult to find a good solution in <strong>&lt; O(n<sup>3</sup>)</strong>. Indeed, it's a question that an ex-colleague was asked during an interview with [Big-G](http://www.google.com).
...
> ```
>>> Return:
>>> * The dimension of the largest square consisting of the same integer (in this case 2 because the largest is 2x2 square of 8s).
>> * The integer which appears in that square (in this case 8)
...
* either smaller than the current maximum

* or just equal to <code>'1'</code>
