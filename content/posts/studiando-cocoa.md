...
date: "2006-03-06T13:08:52Z"
aliases:
  - /2006/03/06/studiando-cocoa
  - /2006/03/studiando-cocoa
---

![Cocoa fruit](http://www.sles.ukzn.ac.za/plantgermcons/cocoa%20fruit%20&%20seeds-1.jpg)
Salve.
Era da parecchio tempo che mi ripromettevo di farlo: finalmente adesso ho trovato il tempo per cominciare il mio studio del framework [Cocoa](http://developer.apple.com/cocoa/).
...
Torniamo a noi.
Da quando sono utente [MacOSX](http://www.apple.com/macosx), aprile del 2003 (o era 2004 :?: ), sono affascinato dalla qualità di questo framework, vera chiave di volta del successo e della qualità dell'HCI dei prodotti creati/sviluppati su/per MacOSX.

Mentre "aspettavo che il mio tempo libero aumentasse", ho preso a cercare manualistica e risorse di ogni tipo riguardo a [Cocoa](http://en.wikipedia.org/wiki/Cocoa_%28API%29) (io sono fatto così, se posso mi faccio sempre trovare preparato agli appuntamenti... :D ), e mi sono persto imbattuto in una serie di lezioni/appunti liberi in italiano (già questo é sufficiente a giustificare il mio stupore).

Si chiama [MaCocoa](http://www.macocoa.omitech.it/): questa (che io definirei propriamente "introduzione pratica" a Cocoa) si é dimostrata subito interessante, attirando la mia attenzione sul fatto che non fosse sviluppata a "Capitoli", bensi a "passi di apprendimento mentali". Si presenta come degli appunti presi mentre l'autore, [Livio Sandel](http://www.macocoa.omitech.it/intro.htm#id001), studiava manuali ufficiali e non. Non mancano frequenti citazioni e riferimenti a questioni "serie", fatte al solo scopo di non passare "sotto silenzio" le questioni meramente tecniche che, sempre e comunque, sono fondamentali per far di noi dei bravi Informatici (e non dei semplici Programmatori).

Riporto l'introduzione:


> Questo disordinato sito documenta il mio (io chi?) percorso di apprendimento di Cocoa, facendo ampie digressioni su tutto ciò che occorre per programmare, sulla Vita, sull'Universo, su Tutto Quanto.
...
Infine, voglio riportare una lista di link a risorse utili che ho raccolto sia studiando MaCocoa, sia googlando:
	...
	* [Marco Coïsson's home page](http://homepage.mac.com/marco_coisson/)

	* [Tevac - Sito indipendente per utenti Apple Italiani](http://www.tevac.com/)
	
* [SofTech - Azienda Software che offre qualche software gratuitamente](http://www.germinara.it/index.htm)

	* [Cocoa Dev Central di Raucci Biagio](http://www.raucci.net/cocoa/indice.html)

	* [Cocoa Dev Central - one of the most popular sites devoted to Mac OS X programming](http://www.cocoadevcentral.com/)

	* [Stepwise.com](http://www.stepwise.com/)

	* [http://osx.hyperjeff.net/](http://osx.hyperjeff.net/)

	* [CocoaDev: CocoaTutorials](http://www.cocoadev.com/index.pl?CocoaTutorials)

	* [Cocoa Sample Code List](http://developer.apple.com/samplecode/Cocoa/index-date.html) (aggiornata in tempo reale)

	* [CocoaLab](http://www.cocoalab.com/developer.htm) (thanks Nemo)
