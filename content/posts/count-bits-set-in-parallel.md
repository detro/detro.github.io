...
aliases:
  - /2010/01/07/count-bits-set-in-parallel
  - /2010/01/count-bits-set-in-parallel
---
...
![Counting kid](http://www.familyhelptree.com/blog/wp-content/uploads/2007/10/counting.jpg)
...
The explaination, from the [source where I took it](http://bits.stephan-brumme.com/countBits.html) (thanks [Luca](http://twitter.com/lucabox) for highlighting it to me):
...
>> * if the rightmost bit is 1, then the rightmost bit of x − 1 is 0. All other bits are identical and x &= x − 1 → x = x − 1. Because all other bits are identical we stripped one set bit, the rightmost bit.
