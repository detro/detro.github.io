...
aliases:
  - /2010/01/22/use-backtracking-to-print-all-subsets
  - /2010/01/use-backtracking-to-print-all-subsets
---

I'm "studying" this algorithmic technique: [Backtracking](http://en.wikipedia.org/wiki/Backtracking). This is an algorithmic approach to problem solution that I trust every good Computer Scientist already uses; but taking a [good theo-practical look](http://www.algorist.com/) at it is something better.



![A Backtracking Tree](http://upload.wikimedia.org/wikipedia/commons/2/2c/Depthfirst.png)
A Backtracking Tree
...
## Solution
Give a good look at the <strong><code>void backtrack(int *curr_sol, int curr_sol_size, int input)</code></strong>: it works as a <strong><em>"skeleton"</em></strong> for <em>generic backtracking</em> algorithms. I'm going to use it in the future as well: I'm going to have fun to implement a [Sudoku](http://en.wikipedia.org/wiki/Sudoku) solver ASAP (probably this weekend). Why? Because I suck at Sudoku: never got into it very much to learn how to play :-P.
