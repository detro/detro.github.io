...
date: "2008-06-15T03:06:34Z"
aliases:
  - /2008/06/15/nokia-should-learn-not-teach
  - /2008/06/nokia-should-learn-not-teach
---

From [Slashdot](http://linux.slashdot.org/article.pl?sid=08/06/13/123206):
...
So, [Nokia](http://www.nokia.com) wants to EAT using the knowledge and the software that the Open Source Community created... and, at the same time, change it's culture and impose concepts that are COMPLETELY against the Open Source "philosophy" itself. Interesting...
Instead of learning of the quality of what the Open Source community is capable of doing using a development model built around <strong>"equality and quality"</strong>, they want to teach/impose? And to who? To the [Trolltech](http://trolltech.com/) employee? They are free to do so... but this does not mean that the rest of the Community will change its mind.
[QT](http://trolltech.com/products/qt)? There is [KDE that has a foundation to protect it](http://www.kde.org/whatiskde/kdefreeqtfoundation.php) PLUS there is always <strong>the Fork option</strong> ;-) .
Think about [XFree86](http://www.xfree86.org/) and [X.org](http://www.x.org/wiki/): nowdays they lost all the users... because of the stupid decision of changing the license.
...
Source: [Pollycoke](http://pollycoke.net/2008/06/14/we-dont-need-your-education/).
