...
tags: [personal]
date: "2009-12-13T22:09:09Z"
aliases:
  - /2009/12/13/find-the-non-repeating-char-in-o-n-time-and-o-1-space
  - /2009/12/find-the-non-repeating-char-in-o-n-time-and-o-1-space
---
...
* the input is always a lowercase string (enforcing this condition is easy and cheap)
...
* Works as long as the set of chars is &lt; number_of_bits(int): that's why I limit it to the english alphabet - generally a <code>u_int</code> is made of <code>32 bits</code> on modern architectures.
...
* It avoids to use of strlen to calculates the length of the input. This makes the solution a "2 * O(n) == O(n)" =&gt; <strong>VERY COOL</strong>
