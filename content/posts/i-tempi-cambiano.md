...
date: "2006-03-07T11:40:23Z"
aliases:
  - /2006/03/07/i-tempi-cambiano
  - /2006/03/i-tempi-cambiano
---

![Mac Mini Rage](http://www.melablog.it/uploads/macminihack.jpg)
...
* 
[RM MY MAC](http://rm-my-mac.wideopenbsd.org.nyud.net:8090/)
...
> Su [ZDnet](http://www.zdnet.com.au/news/security/soa/Mac_OS_X_hacked_in_less_than_30_minutes/0,2000061744,39241748,00.htm) appare la notizia: Gwerdna, sarebbe riuscito ad impossessarsi del Mac (il primo della lista di cui sopra) in meno di 30 minuti, sfruttando una falla del sistema non pubblica. In ogni caso deve essere un soggetto particolarmente abile: "<em>ci ho messo 20 minuti in più di quanti ce ne ho messi con Windows Xp</em>". Come notano in molti, il sito ha pubblicato anche il local account della macchina, un dato che facilita non poco il lavoro degli hacker... 
...
Source, [Melablog](http://www.melablog.it/post/1594/1594).
...
Ora però c'é da aggiungere qualche citazione: prima fra tutti, quella su [attivissimo.blog](http://attivissimo.blogspot.com/2006/03/mac-bucato-in-30-min.html):
...
Il sito [rm my Mac](http://rm-my-mac.wideopenbsd.org.nyud.net:8090/) non ha messo online una macchina Apple "as is", bensì ha creato un sito in cui le persone potevano prima crearsi un account [SSH](http://en.wikipedia.org/wiki/SSH), da lì loggarsi e quindi tentare una SCALATA DI PRIVILEGI dall'Interno. Una cosa molto diversa direi.

Per rispondere a questa CAZZATA, [MacOSX Security Test](http://test.doit.wisc.edu/) ha fatto la stessa cosa ma senza SSH, volendo dimostrare la robustezza dei sistemi MacOSX (ma io direi di tutti i sistemi *Nix) per quanto riguarda gli attacchi via Web (che erano quelli in discussione). Ebbene, il MacMini é stato ormai spento perché NESSUNO é riuscito, malgrado una quantità enorme di attacchi, ad entrare nella macchina.

Quella proposta da [rm my Mac](http://rm-my-mac.wideopenbsd.org.nyud.net:8090/) era una semplice scalata di privilegi, da eseguire "dall'interno del sistema", non via web (se non sapete cosa sia [SSH](http://en.wikipedia.org/wiki/SSH), documentatevi su [Wikipedia](http://en.wikipedia.org/wiki/SSH)).
