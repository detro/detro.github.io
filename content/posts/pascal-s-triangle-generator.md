...
aliases:
  - /2010/01/11/pascal-s-triangle-generator
  - /2010/01/pascal-s-triangle-generator
---

What's [Pascal's Triangle](http://en.wikipedia.org/wiki/Pascal)? That's what it is ([Wikipedia](http://en.wikipedia.org/wiki/Pascal) has all the theory, if you need).



![Pascal](http://upload.wikimedia.org/wikipedia/commons/thumb/f/f6/Pascal%27s_triangle_5.svg/250px-Pascal%27s_triangle_5.svg.png)
...
Clearly this is nothing special. Just a little trick to avoid to use a triangular matrix. [Memory is not cheap](http://www.google.co.uk/products?hl=en&safe=off&q=memory%20prices&lr=&um=1&ie=UTF-8&sa=N&tab=wf), you know! ;-)
