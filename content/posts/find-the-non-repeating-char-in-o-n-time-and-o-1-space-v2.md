...
aliases:
  - /2009/12/18/find-the-non-repeating-char-in-o-n-time-and-o-1-space-v2
  - /2009/12/find-the-non-repeating-char-in-o-n-time-and-o-1-space-v2
---

My colleague and friend Luca ([@lucabox](http://twitter.com/lucabox)) described a better solution to the problem of <em>"[Finding the first non repearing char in a string in O(n) time and O(1) space](http://www.detronizator.org/2009/12/13/find-the-non-repeating-char-in-on-time-and-o1-space/)"</em>. It uses smartly the space, making the solution nicer and slicker.
...
Again, this comes from Luca Colantonio ([http://uk.linkedin.com/in/lucacolantonio](http://uk.linkedin.com/in/lucacolantonio)), smart ass that is too lazy to maintain a blog and post it himself (or even implementing himself - he just explained to me at work and I had to code it). Thanks Luca ;)
