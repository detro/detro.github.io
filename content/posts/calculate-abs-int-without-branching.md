...
aliases:
  - /2010/01/13/calculate-abs-int-without-branching
  - /2010/01/calculate-abs-int-without-branching
---

For this you need someone to teach it to you: if you made it yourself, then you are a very good [Comp-Sci](http://en.wikipedia.org/wiki/Computer_science), and you should send your CV to [Google](http://www.google.co.uk/intl/en/jobs/) ASAP. ;)

## Without branching O_o?
Yes, without using any "<code>if ( a < 0 )...</code>". To do that, you need to refresh how [Two's Complement works](http://en.wikipedia.org/wiki/Two), then come back.
...
* A variable carrying <code>0</code> if the input is positive, <code>1</code> otherwise
...
* <strong><code>A ^ 0 = A</code></strong>

* <strong><code>A ^ 1 = ~A</code></strong>

* <code>A ^ A = 0</code>

* <code>A ^ B = B ^ A</code> (commutative)
